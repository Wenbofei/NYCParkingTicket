...
#data2013 = read.csv('nyc-parking-tickets/Parking_Violations_Issued_-_Fiscal_Year_2014__August_2013___June_2014_.csv')
...
index0 = which(hour>=13) # Identifying the Outliers
