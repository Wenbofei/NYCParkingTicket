...
for(i in 1:N){
  ...
  #OurLocation[i,3] = geocode_OSM(paste(Street,', New York, NY,  United States of America'))$coords[1]
  #OurLocation[i,4] = geocode_OSM(paste(Street,', New York, NY,  United States of America'))$coords[2]
