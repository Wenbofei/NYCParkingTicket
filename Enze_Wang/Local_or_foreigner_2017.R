...
colnames(data2017)
#统计Registration项
Registration = data2017[,'Registration.State']
#统计各个州的违法人数
#美国各州为:
...
#输出频数频率表
write.csv(Registration_Freq_Ratio,file='~/Desktop/605project/2017_Registration_Freq_Ratio.csv',row.names=FALSE)
...
ggsave("~/Desktop/605project/log_registration_ratio_of_2017_ticket_in_NY.png")
