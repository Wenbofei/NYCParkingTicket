...
library(usmap)
library(ggplot2)
plot_usmap(data = Registration_Freq_Ratio,values = 'logRatio')+scale_fill_continuous(low='blue',high='red',name='log registration ratio of 2014 ticket in NY')+theme(legend.position='right')
