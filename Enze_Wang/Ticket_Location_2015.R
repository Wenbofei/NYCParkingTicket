...
Location = data.frame(data2015[,c('Street.Name')])
...
OurLocation=na.omit(OurLocation)
write.csv(OurLocation,file='~/Desktop/605project/2015_OurLocation.csv',row.names=FALSE)
...
#把地图保存为图片
mapshot(a, file =  "~/Desktop/605project/2015_Location.png")
